        ...
        if df_raw.empty:
            ...
            if df_venc.empty:
                ...
                with col_kpi3:
                    st.metric(
                        "Total Já Pago", 
                        fmt_moeda(df_pagos["valor"].sum()) if not df_pagos.empty else "R$ 0,00"
                    )
                ...
                tab_pendentes, tab_pagas = st.tabs([
                    f"⏳ Contas Pendentes ({len(df_pendentes)})", 
                    f"✅ Contas Pagas ({len(df_pagos)})"
                ])
                            ...
                            with st.expander(
                                ...
                                with col_btn_pago:
                                    if st.button(
                                        ...
                                        if sucesso_todos:
                                            st.cache_data.clear()
                                            st.success("Transferido para a aba de Pagos!")
                                            st.rerun()
                                        else:
