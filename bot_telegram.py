...
def main():
    ...
    # O Telegram reutiliza allowed_updates anteriores quando não são informados.
    # Solicitar callbacks explicitamente evita receber comandos sem receber cliques.
